...
(function() {
    ...
    function initializeScene(flagFound) {
        miniMap = new Demonixis.Gui.MiniMap(map[0].length, map.length, "canvasContainer");
        miniMap.create(undefined, undefined, undefined, undefined, flagFound);
    ...
    Demonixis.ShowMiniMap = function enableMiniMap(flag) {
        if (flag == true) {
